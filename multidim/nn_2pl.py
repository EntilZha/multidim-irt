...
@abstract_model.IrtModel.register("nn_2pl")
class NNTwoParamLog(abstract_model.IrtModel):
    """2PL IRT model"""
    ...
    def guide_hierarchical(self, subjects, items, obs):
        ...
        pyro.sample("mu_a", dist.Gamma(loc_mu_a_param, scale_mu_a_param))
        ...
        with pyro.plate("bs", self.num_items, device=self.device):
            ...
            pyro.sample("a", dist.Gamma(m_a_param, s_a_param))
